 ...
 */
/**
 * 在配置 webpack的时候，默认 webpack命令编译的是 webapck.config.js，我们可以改变编译的文件名字，这个提高灵活性，命令如下：
 * webpack --config 文件名.js
 */
/**
 *entry
 * 定义：就是当前项目的入口文件
 ...
 */
/**
 * plugins 以数组的方式添加 (这里要注意 这个插件除了第三方提供的，要require引入外，其实内置的也有 很多常用 plugins插件)
